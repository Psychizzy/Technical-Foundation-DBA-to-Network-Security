...
![TCP Handshake Analysis](images/wireshark_tcp_handshake.png)
...
## 📸 Final Network Architecture Diagram

![Secure VLAN Network Architecture](images/vlan_network_diagram.png)
